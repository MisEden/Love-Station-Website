...
window.onload = function() {
    ...
    let checkinurl = new URL(location.href);
    checkinurl=checkinurl.search
    console.log(checkinurl.search)
    appid=checkinurl.substr(4)
    console.log(appid);
    
    // 取得RoomState相關入住資訊
   fetch( API_url + '/v1/api/admins/me/forms/checkin/' + appid, {
       method: 'GET',
       headers: new Headers({
